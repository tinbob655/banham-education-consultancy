        ...
        return (
            <React.Fragment>
                ...
                <div>
                    ...
                    <p className="alignLeft">
                        We offer a range of support packages for schools and students, specialising in providing practical ways to help all students fully engage with their learning, remember more and perform better in tests and exams. <br/><br/>These services are:
                    </p>
                </div>
                ...
                <div>
                    ...
                    <p className="alignLeft" style={{marginTop: '2vh'}}>
                        •	Bespoke support for trusts and schools in developing a rigorous History curriculum that delivers excellent outcomes for all students. 
                    </p>
